...
export default function GdprInput() {
    return (
        <label className="flex flex-row items-center gap-sm cursor-pointer">
            ...
            <div className="w-4 h-4 border flex items-center justify-center peer-checked:bg-primary peer-checked:border-primary transition-colors duration-200">
                <IconCheckFillDuo18 className="text-surface  peer-checked:hidden" />
            </div>
